    ...
    <>
        <div className="mt-10 p-4 border-b">
                ...
                <div className="flex items-center justify-end gap-2">
                    ...
                    {/* <Link href={`/posts/${post.id}/edit`} className='bg-green-500 rounded-md text-sm px-4 py-2 text-white'>Update</Link> */}
                    <Link href={route('posts.edit', post)} className='bg-green-500 rounded-md text-sm px-4 py-2 text-white'>Update</Link>
                </div>
        </div>
    </>
)
